...
object Load_bi_kh_manager_2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    CreateHFTHiveTableInfo.create_table_bi_kh_manager_2(spark,hivedatabase,isDropTable)

    //同步表相关信息定义
    val real_tableName = "bi_kh_manager_2"
    val dataFrame_temp_view = "bi_kh_manager_2_view"
    val customize_tableName = SelectRelectionDBTableUtils.select_bi_kh_manager_2()

    val task_name = "Load_bi_kh_manager_2"
